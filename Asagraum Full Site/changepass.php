...
<body> 
    <form action="https://mayar.abertay.ac.uk/~2003114/cmp204/coursework2/changepass.php" method="post" id=login> <!--submits form details to confirmation page which changes password-->
    <h3>Please enter your account details.</h3>
    <br>
    Username: <input type="text" name = "user">
    <br><br>
    Password: <input type="password" name = "oldpass">
    <br><br>
