...
<div class ="login">
    <form action="https://mayar.abertay.ac.uk/~2003114/cmp204/coursework2/createaccountconfirm.php" method="post" id=login>
    <h3>Please enter the login details you wish to use.</h3>
    <br>
